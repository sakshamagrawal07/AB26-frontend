...
const MaskModel = (props) => {
    ...
    useFrame((state) => {
        ...
        meshRef.current.rotation.x = THREE.MathUtils.lerp(meshRef.current.rotation.x, baseRotation[0] + tiltX, 0.1);
        meshRef.current.rotation.y = THREE.MathUtils.lerp(meshRef.current.rotation.y, baseRotation[1] + tiltY, 0.1);
    ...
    return (
        <section className="relative w-full min-h-screen bg-black text-[#D4AF37] overflow-hidden flex flex-col justify-center px-6 md:px-16 py-8 md:py-12">
            ...
            <div className="w-full mb-12 md:mb-24 relative z-20">
                <h1 className="tracking-wide uppercase text-5xl sm:text-6xl md:text-8xl" style={{ fontFamily: "'Adqila', serif", fontWeight: 400 }}>
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-2 2xl:grid-cols-12 gap-8 md:gap-16 items-start relative z-20">
                ...
                */}
                <div className="md:col-span-1 2xl:col-span-3 flex flex-col items-start pt-2">
                    ...
                    <h2 className="text-[#FDB931] text-4xl sm:text-5xl md:text-5xl lg:text-6xl font-serif tracking-[0.1em] uppercase leading-tight">
                        Enchanted
                    </h2>
                    <h2 className="text-[#FDB931] text-4xl sm:text-5xl md:text-5xl lg:text-6xl font-serif tracking-[0.1em] uppercase leading-tight mt-0">
                        Circus
                    </h2>
                </div>
                ...
                */}
                <div className="hidden md:flex md:col-span-1 md:col-start-2 md:row-start-1 md:row-span-2 2xl:col-span-4 2xl:col-start-auto 2xl:row-start-auto 2xl:row-span-1 relative h-[400px] md:h-full lg:h-[600px] w-full items-center">
                    {isDesktop && (
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] z-10 pointer-events-auto">
                            ...
                            >
                                ...
                                <spotLight position={[5, 2, 8]} angle={0.5} penumbra={1} intensity={8} color="#FFD700" castShadow />
                                {/* Fill Light from opposite side */}
                                <pointLight position={[-5, 0, 5]} intensity={2} color="#FDB931" />
